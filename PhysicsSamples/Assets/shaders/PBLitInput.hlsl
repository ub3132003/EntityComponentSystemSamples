...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _HeightFogColor)
    UNITY_DOTS_INSTANCED_PROP(float , _HeightFogStart)
    UNITY_DOTS_INSTANCED_PROP(float , _HeightFogEnd)
...
#define _HeightFogColor         UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__HeightFogColor)
#define _HeightFogStart         UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__HeightFogStart)
#define _HeightFogEnd           UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__HeightFogEnd)
