...
namespace UnityEditor.Rendering.Universal
{
    ...
    sealed class PBSavedBool : SavedParameter<bool>
    {
        public PBSavedBool(string key, bool value)
            : base(key, value, EditorPrefs.GetBool, EditorPrefs.SetBool) {}
    }

    sealed class PBSavedInt : SavedParameter<int>
    {
        public PBSavedInt(string key, int value)
            : base(key, value, EditorPrefs.GetInt, EditorPrefs.SetInt) {}
    }

    sealed class PBSavedFloat : SavedParameter<float>
    {
        public PBSavedFloat(string key, float value)
            : base(key, value, EditorPrefs.GetFloat, EditorPrefs.SetFloat) {}
    }

    sealed class PBSavedString : SavedParameter<string>
    {
        public PBSavedString(string key, string value)
